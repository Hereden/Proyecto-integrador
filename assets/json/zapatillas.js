Zapatillas = [
  ...
  {
    "nombre": "Zapatillas de montaña Sport",
    "descripcion": "El extraordinario rendimiento y valor que poseen las zapatillas de montaña Sport, las hacen una de los pares más vendidas. Su gran durabilidad y poco peso presentan un diseño de ajuste con tecnología Body Geometry Fit, comodidad, cierre de correas de desplazamiento con tecnología Velcro® y una suela con tracción mejorada para caminatas",
    "marca": "",
    "precio": 1154.00,
  ...
  {
    "nombre": "Zapatos de Ciclismo sapatilha Ciclismo MTB Hombres",
    "descripcion": "La estructura de la copa de talón en U aumenta la estabilidad: el talón engrosado tiene una estructura interior curva, en otras palabras, esos zapatos de ciclismo para hombre están diseñados con tacón en U (copa del talón) que tiene forma anatómica alrededor del talón y el tobillo para evitar torcer los tobillos proporcionando un mejor apoyo y estabilidad.",
    "marca": "MTB",
    "precio": 1097.50,
  ...
  {
    "nombre": "WYUKN Zapatos de Ciclismo MTB,Calzado para Ciclismo Calzado para Bicicleta de Carretera para Hombre, Zapatillas de Senderismo al Aire Libre, Jogger Hombre,blackcolor-43EU",
    "descripcion": "Zapatos de conducción sin candados de moda: Diseño en forma de diente de la suela, transmisión de potencia efectiva y comodidad, sin una hebilla, sigue siendo fácil de conducir, sistema de bloqueo rápido, puntera anticolisión, lo que hace que su conducción sea más segura.",
    "marca": "WYUKN",
    "precio": 999.99,
  ...
  {
    "nombre": "Govoland Zapatos De Bicicleta Profesionales",
    "descripcion": "Zapatos De Bicicleta De Carretera con Bloqueo Automático para Hombres, Zapatillas De Bicicleta para Mujer",
    "marca": "Govoland",
    "precio": 993.99,
    ...
    "especificaciones": [
      {
        ...
        "Transpirabilidad": "la perforación en la parte superior aumenta la transpirabilidad, lo que es adecuado para montar en climas cálidos o ejercicio extenuante.",
  ...
  {
    "nombre": "SANDUGO Zapatillas de Bicicleta de montaña MTB para Hombre",
    "descripcion": "2 Pernos, aptas para Todos los Pedales SPD, Ligeras y cómodas",
    "marca": "SANDUGO",
    "precio": 1842.25,
    ...
    "especificaciones": [
      {
        ...
        "Diseñado para el rendimiento": "una suela exterior con lengüetas de alta tracción de goma fuerte moldeada de longitud completa para agarre y durabilidad. Entresuela de Eva moldeada por compresión con placa de plantilla de nailon mejorada lo suficientemente rígida para la transferencia de energía más eficiente cuando pedaleas. Además, este diseño especial hace que sea mucho más fácil caminar después de andar en bicicleta.",
  ...
  {
    "nombre": "WYUKN Zapatos de Ciclismo MTB",
    "descripcion": "Zapatos de conducción sin candados de moda: Diseño en forma de diente de la suela, transmisión de potencia efectiva y comodidad, sin una hebilla, sigue siendo fácil de conducir, sistema de bloqueo rápido, puntera anticolisión, lo que hace que su conducción sea más segura.",
    "marca": "WYUKN",
    "precio": 1071.99,
  ...
  {
    "nombre": "Shoes Zapatillas de Bicicleta de montaña",
    "descripcion": "Zapatillas Ligeras sin traba para Hombres y Mujeres, Zapatillas de Senderismo Antideslizantes, adecuadas para la conducción Deportiva al Aire Libre",
    "marca": "ZDDAB",
    "precio": 1140.05,
    ...
    "especificaciones": [
      {
        ...
        "Diseño antideslizante y duradero": "suela resistente al desgaste, lámina de goma para apoyar el talón, soporte para la estabilidad del tobillo, ayuda a mantener el talón estable y ayuda rápidamente durante el ejercicio",
